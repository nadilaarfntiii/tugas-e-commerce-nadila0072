	...
	*/
	...
	$(document).ready(function() {
		...
		$('.category').click(function(e) {
		  ...
		  // Ambil kategori yang diklik dari atribut data-category
		  var category = $(this).data('category');
		  
		  // Jika "All Category" dipilih, tampilkan semua produk
		  if (category === 'all') {
			$('.product-item').show(); // Tampilkan semua produk
		  } else {
			...
			// Pindahkan produk yang ditampilkan ke atas
			$('.' + category).prependTo('.product-list'); // Memindahkan produk kategori terpilih ke atas
		  }
	  
		  // Update class 'active' untuk sidebar
		  $('.category').parent().removeClass('active');
		  $(this).parent().addClass('active');
		});
	  
		// Pada awal halaman di-load, bisa disesuaikan produk yang tampil
		// Misalnya menampilkan semua produk di awal
		$('.product-item').show();
	  });
